...
import type { BacktestPoint, ExtensionPage } from "@/lib/types";
...
export default function ExtensionShell({ live }: { live?: BacktestPoint | null }) {
  ...
  return <ExtensionDataProvider live={live}><div className="extension-shell"><NavRail current={page} onNavigate={setPage} /><CurrentPage onNavigate={setPage} /></div></ExtensionDataProvider>;
}
